...
package com.yanshi.my36kr.common.view.slidingTab;
 ...
 *
 * 添加了设置所有tab都占满的方法{@link #setViewPager(android.support.v4.view.ViewPager, int)}
 * updated by yanshi
 */
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    protected TextView createDefaultTabView(Context context) {
         ...
         * 设置宽度（若需要所有tab占满屏幕）
         */
        if (screenX != 0) textView.setWidth(screenX);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                 ...
                 * 设置宽度
                 */
                if (screenX != 0) tabTitleView.setWidth(screenX);
            }
